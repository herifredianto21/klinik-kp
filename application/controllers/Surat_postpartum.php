...
class Surat_postpartum extends CI_Controller {
	...
	public function __construct()
	{
		...
		$this->load->model('surat_postpartum_model', 'model');
	...
	{
		$this->load->view('surat_postpartum');
    }
    ...
    public function cetak($id = 0)
    {
    	$response = $this->model->edit($id);
    	if ($response['result']) {
    		$this->load->view('surat_postpartum_cetak', $response['data']);
    	}
    }
