...
class Surat_hamil extends CI_Controller {
	...
	public function __construct()
	{
		...
		$this->load->model('surat_hamil_model', 'model');
    ...
    public function cetak($id = 0)
    {
    	$response = $this->model->edit($id);
    	if ($response['result']) {
    		$this->load->view('surat_hamil_cetak', $response['data']);
    	}
    }
