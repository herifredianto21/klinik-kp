...
class Kelas_asuransi extends CI_Controller {
	...
	public function __construct()
	{
		...
		$this->load->model('kelas_asuransi_model', 'model');
    ...
    public function select_asuransi()
    {
    	$response 	= array(
			'result'	=> false,
			'msg'		=> ''
		...
		$response = $this->model->select_asuransi();
    	echo json_encode($response, JSON_PRETTY_PRINT);
    }
