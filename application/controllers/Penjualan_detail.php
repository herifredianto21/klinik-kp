...
class Penjualan_detail extends CI_Controller {
	...
	public function __construct()
	{
		...
		$this->load->model('penjualan_detail_model', 'model');
	...
	{
		$this->session->set_userdata('idPenjualan', $id);
		$this->load->view('penjualan_detail');
    }
    ...
    {
    	$id = $this->session->userdata('idPenjualan');
