...
class Surat_sakit extends CI_Controller {
	...
	public function __construct()
	{
		...
		$this->load->model('surat_sakit_model', 'model');
    ...
    public function cetak($id = 0)
    {
    	$response = $this->model->edit($id);
    	if ($response['result']) {
    		$this->load->view('surat_sakit_cetak', $response['data']);
    	}
    }
