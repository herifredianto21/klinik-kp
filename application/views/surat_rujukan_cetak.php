			...
			<table align="center" width="100%" border="0" cellpadding="5">
				...
				<tr>
					<td colspan="2" align="center">
						<h2><u>SURAT KETERANGAN SAKIT</u></h2>
					</td>
				</tr>
			</table>
			...
			<table align="center" width="100%" border="0" cellpadding="5">
				<tbody>
                    ...
                    <tr>
						<td width="5%">&nbsp;</td>
						<td width="15%">&nbsp;</td>
						<td width="80%">G: <?php echo $gravida; ?> P: <?php echo $partus; ?> A: <?php echo $aborsi; ?></td>
					</tr>
                    <tr>
						<td width="5%">&nbsp;</td>
						<td width="15%">Keluhan</td>
						<td width="80%">: <?php echo $keluhan_pasien; ?></td>
					</tr>
                    <tr>
						<td width="5%">&nbsp;</td>
						<td width="15%">Alamat</td>
						<td width="80%">: <?php echo $diagnosa_pasien; ?></td>
					</tr>
                    <tr>
						<td width="5%">&nbsp;</td>
						<td width="30%">Tindakan/obat yang sudah diberikan</td>
						<td width="65%">: <?php echo $tindakan; ?></td>
					</tr>
					<tr>
						<td colspan="3">Demikian, terima kasih atas kerja samanya.</td>
					</tr>
				</tbody>
			</table>
