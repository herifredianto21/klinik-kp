		...
		<td colspan="4">
			...
			<table align="center" width="100%" border="0" cellpadding="5">
				<tbody>
					...
					<tr>
						<td colspan="3">Dengan usia kehamilan <b><?php echo $usia_kehamilan; ?></b> ( <?php echo terbilang($usia_kehamilan); ?> ) bulan dan telah sampai waktunya untuk mendapatkan cuti, terhitung mulai tanggal <?php echo tglIndo($dari_tanggal); ?> s/d <?php echo tglIndo($sampai_tanggal); ?></td>
					</tr>
				</tbody>
			</table>
