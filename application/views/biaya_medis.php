...
<head>
  ...
  <title>
    Klinik Nur Khadijah | Tindakan & Biaya Medis
  </title>
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="">Tindakan & Biaya Medis</a>
          </div>
          ...
          <div id="table" class="col-md-12">
            <div class="card">
              <div class="card-header">
                <div class="row">
                	<div class="col-6">
                		<h4 class="card-title"> Tabel Tindakan & Biaya Medis</h4>
                	</div>
                	<div class="col-6">
                ...
                <form id="formData">
                	<div class="row">
                		<div class="col-md-6">
                			<div class="form-group">
                				...
                				<input type="text" name="nama_biaya_medis" class="form-control" placeholder="Nama Tindakan Medis" required>
                			</div>
                		</div>
                		<div class="col-md-6">
                			<div class="form-group">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="number" name="jasa_medis" class="form-control" placeholder="Jasa Medis" value="0">
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        <label>Klinik</label>
                        <input type="number" name="jasa_klinik" class="form-control" placeholder="Jasa Klinik" value="0">
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
