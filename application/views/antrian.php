          ...
          <div id="table" class="col-md-12">
            <div class="card">
              <div class="card-header">
                <div class="row">
                  <div class="col-12">
                    <h2 class="card-title"><center> Laporan Kunjungan</center></h4>
                  </div>
                </div>
                <!-- start pencarian -->
                <form method="GET" action="<?php echo base_url('Antrian/filter');?>">  
                    <div class="row">
                      <div class="col-2">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-1">
                        <div class="form-group">
                          <button  class="btn btn-primary btn-sm" style="margin-top:5px;">Cari</button>
                        </div>
                      </div>
                    </div>
                </form>
