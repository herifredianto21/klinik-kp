...
if($id==9){ ?>
  ...
  <?php
	...
	header("Content-Disposition: attachment; filename=Laporan_Rekam_Medis_UMUM.xls");
  ?>

    <table align="center" border="0" width="100%">
      <tr align="center"><td colspan="4"><b>LAPORAN PROGRAM REKAM MEDIS - UMUM</b></td></tr>
...
<?php } else if($id==34){ ?>
  ...
  <?php
	header("Content-type: application/vnd-ms-excel");
	header("Content-Disposition: attachment; filename=Laporan_Rekam_Medis_ISPA.xls");
  ?>

  <table align="center" border="0" width="100%">
      <tr align="center"><td colspan="4"><b>LAPORAN BULANAN PROGRAM REKAM MEDIS - ISPA</b></td></tr>
      <tr align="center"><td colspan="4"><b>KLINIK UTAMA NUR KHADIJAH</b></td></tr>
      <tr>
        <td colspan="4">
          <table align="center" width="100%" border="1" cellpadding="3">
...
<?php } else if($id==3){ ?>
  ...
  <?php
	header("Content-type: application/vnd-ms-excel");
	header("Content-Disposition: attachment; filename=Laporan_Rekam_Medis_Persalinan.xls");
  ?>

    <table align="center" border="0" width="100%">
      <tr align="center"><td colspan="4"><b>LAPORAN BULANAN PROGRAM REKAM MEDIS - PERSALINAN</b></td></tr>
      <tr align="center"><td colspan="4"><b>KLINIK UTAMA NUR KHADIJAH</b></td></tr>
      <tr>
        <td colspan="4">
          <table align="center" width="100%" border="1" cellpadding="3">
...
<?php } else if($id==37){ ?>
  ...
  <?php
	header("Content-type: application/vnd-ms-excel");
	header("Content-Disposition: attachment; filename=Laporan_Rekam_Medis_KB.xls");
  ?>
    <table align="center" border="0" width="100%">
      <tr align="center"><td colspan="4"><b>LAPORAN BULANAN PROGRAM REKAM MEDIS - KB</b></td></tr>
      <tr align="center"><td colspan="4"><b>KLINIK UTAMA NUR KHADIJAH</b></td></tr>
      <tr>
        <td colspan="4">
          <table align="center" width="100%" border="1" cellpadding="3">
...
<?php } else if($id==1){ ?>
  ...
  <?php
	header("Content-type: application/vnd-ms-excel");
	header("Content-Disposition: attachment; filename=Laporan_Rekam_Medis_Kehamilan.xls");
  ?>

  <table align="center" border="0" width="100%">
      <tr align="center"><td colspan="4"><b>LAPORAN BULANAN PROGRAM REKAM MEDIS - KEHAMILAN</b></td></tr>
      <tr align="center"><td colspan="4"><b>KLINIK UTAMA NUR KHADIJAH</b></td></tr>
      <tr>
        <td colspan="4">
          <table align="center" width="100%" border="1" cellpadding="3">
...
<table align="center" border="0" width="100%">
    <tr align="center"><td colspan="4"><b>LAPORAN BULANAN PROGRAM REKAM MEDIS - IMUNISASI</b></td></tr>
    <tr align="center"><td colspan="4"><b>KLINIK UTAMA NUR KHADIJAH</b></td></tr>
    <tr>
      <td colspan="4">
        <table align="center" width="100%" border="1" cellpadding="3">
