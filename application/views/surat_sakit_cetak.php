		...
		<td colspan="4">
			...
			<table align="center" width="100%" border="0" cellpadding="5">
				<tbody>
					...
					<tr>
						<td colspan="3">SAKIT dan memerlukan istirahat selama <?php echo $lama; ?> (<?php echo terbilang($lama); ?>) hari, dari tanggal <?php echo date('d-m-Y', strtotime($dari_tanggal)); ?> s/d <?php echo date('d-m-Y', strtotime($sampai_tanggal)); ?></td>
					</tr>
				</tbody>
			</table>
